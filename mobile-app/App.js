...
import BPHistoryScreen from "./src/screens/BPHistoryScreen";
    ...
    <WalletProvider>
      <NavigationContainer>
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen
            name="DietaryManager"
            component={DietaryManagerScreen}
          />
          <Stack.Screen name="DietaryPlan" component={DietaryPlanScreen} />
          <Stack.Screen
            name="NutrientWallet"
            component={NutrientWalletScreen}
          />
          ...
          <Stack.Screen
            name="LabImageUpload"
            component={LabImageUploadScreen}
          />
          <Stack.Screen name="LabAnalysis" component={LabAnalysisScreen} />
          <Stack.Screen name="LabResult" component={LabResultScreen} />
          <Stack.Screen
            name="ManualLabEntry"
            component={ManualLabEntryScreen}
          />
          <Stack.Screen
            name="FutureCKDStage"
            component={FutureCKDStageScreen}
          />
          <Stack.Screen
            name="FutureCKDStageResult"
            component={FutureCKDStageResultScreen}
          />
          <Stack.Screen
            name="FutureCKDStageHistory"
            component={FutureCKDStageHistoryScreen}
          />
          <Stack.Screen
            name="MyProgressPath"
            component={MyProgressPathScreen}
          />
          <Stack.Screen name="BPHistory" component={BPHistoryScreen} />
          <Stack.Screen
            name="RiskHistory"
