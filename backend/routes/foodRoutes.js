...
router.post('/detect', upload.single('image'), async (req, res) => {
    try {
        ...
        try {
            ...
            aiResponse = await axios.post('http://nephro-food-engine:5001/predict_meal_with_portions', form, {
                headers: { ...form.getHeaders() }
            });
            ...
            aiResponse = await axios.post('http://nephro-food-engine:5001/predict_meal', fallbackForm, {
