...
Write-Host "`n[1/4] Patching axiosConfig.js to use 127.0.0.1..." -ForegroundColor Cyan
...
Write-Host "`n[3/4] Starting backend on port 5000..." -ForegroundColor Cyan
...
# ── Step 4: Launch app ────────────────────────────────────────────────────────
Write-Host "`n[4/4] Launching Expo app on Android..." -ForegroundColor Cyan
